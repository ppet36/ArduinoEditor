...
wxDEFINE_EVENT(EVT_PROCESS_TERMINATE_REQUEST, wxCommandEvent);

wxDEFINE_EVENT(EVT_OUTDATED_UPDATED, wxThreadEvent);

wxDEFINE_EVENT(EVT_LIBRARY_INDEX_UPDATED, wxThreadEvent);

wxDEFINE_EVENT(EVT_CORE_INDEX_UPDATED, wxThreadEvent);
