...
// automatic lib/cores update check
wxDECLARE_EVENT(EVT_OUTDATED_UPDATED, wxThreadEvent);
wxDECLARE_EVENT(EVT_LIBRARY_INDEX_UPDATED, wxThreadEvent);
wxDECLARE_EVENT(EVT_CORE_INDEX_UPDATED, wxThreadEvent);
